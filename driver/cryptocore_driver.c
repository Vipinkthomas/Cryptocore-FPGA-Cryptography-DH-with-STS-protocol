   ...
   u32 mwmac_cmd;
	...
	switch(cmd) {
      ...
      case IOCTL_READ_RAM_B:
         ...
         iowrite32(val, (MWMAC_RAM_ptr+0x2+0x4));
         iowrite32(val, (MWMAC_RAM_ptr+0x200));
         mwmac_cmd = (1 << 0) | (0 << 1) | (1 << 2) | (0 << 3) | (0x0 << 4) | (MONTMULT << 8)| (MWMAC_RAM_B1 << 12) | (MWMAC_RAM_A1 << 17) | (0x0 << 22) | (0x0 << 27);
